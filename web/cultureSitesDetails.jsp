...
<div class="mainwidth1 mt20 clearfix">
            ...
            <ul class="c_left_menu">
                ...
                <li class="c_menu_li">
                    ...
                    <a class="c_menu_main" id="type" href="javascript:void(0)"
                       onclick="findType('<%=location.getId()%>');return false;">
    ...
    <div class="pc_right r">
        ...
        <div class="pr_detail">
            ...
            <%
                CultureSites cultureSites = (CultureSites) request.getAttribute("cultureSitesDetails");
            %>
            <div class="centent_title">
                <span title="标题"><%= cultureSites.getTitle()%></span>
            </div>
            <div class="article_ori">
                <%--  <p>来源：宜兴社区培训学院 发布时间：2019/4/10 作者：jyadmin 阅读次数：127  </p>--%>
                <p>发布时间：<%= cultureSites.getOnlinetime()%>
                </p>
                <a onclick="javascript:CreateCollection(7264,2);" style="cursor: pointer;">收藏</a>
            </div>
            <div class="article_content">
                <img src="<%=cultureSites.getImg()%>">
                <p><span style="font-family: 宋体, SimSun;">&nbsp; <%=cultureSites.getContent()%></span></p>
            </div>

    ...
    <div class="pc_right r">
        ...
        <div class="cm-lesson">
            ...
            <div class="cm-lesson-con" style="display:none;">
                <ul>
                    <%
                        List<NativeProduct> productList1 = (List<NativeProduct>) request.getAttribute("productList");
                        for (NativeProduct product : productList1) {
                    %>
                    <li class="lesson-brief2 clearfix">
                        <div class="lb2-left l">
                            <a href="<%=path%>/product?method=details&id=<%= product.getId()%>"><img src="<%=path%>/<%=product.getImg()%>"
                            ...
                            <div class="lb2-right-hd clearfix">
                                <div class="lb2-right-hd1 ">
                                    <p class="lb2-right-hd1-p1 clearfix">
                                        <a href="<%=path%>/product?method=details&id=<%= product.getId()%>" class="l"><%=product.getName()%></a>
                                        <span class="r"><%=product.getOnlinetime()%></span>
                                    </p>
                                </div>

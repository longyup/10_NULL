    ...
    <div class="nav">
        <div class="nav-con">
            <ul class="clearfix">
                ...
                <li><a href="<%=path%>/culture.jsp" style="color:white;" class="nl-title">名人趣事</a></li>
                <li><a href="<%=path%>/culture.jsp" style="color:white;" class="nl-title">风俗民情</a></li>
                <li><a href="<%=path%>/activity?method=activityMessage" style="color:white;" class="nl-title">活动一览</a></li>
                <li><a href="<%=path%>/culture.jsp" style="color:white;" class="nl-title">杂谈交流</a></li>

    ...
    <div class="nav">
        <div class="nav-con">
            <ul class="clearfix">
                ...
                <li><a href="<%=path%>/culture?method=topage" style="color:white;" class="nl-title">名人趣事</a></li>
                <li><a href="<%=path%>/folk_custom?method=topage" style="color:white;" class="nl-title">风情民俗</a></li>
                <li><a href="<%=path%>/culture?method=topage" style="color:white;" class="nl-title">活动一览</a></li>
